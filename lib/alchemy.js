...
Alchemy.translate.text = function(text, from, to, customer, token, callback) {
  var options = {
    ...
    qs: {text: text, from: from, to: to, customer: customer, project: 'fake', asset: 'fake', token: token},
...
Alchemy.translate.htmlFragment = function(html, from, to, customer, token, callback) {
  var options = {
    ...
    qs: {html: html, from: from, to: to, customer: customer, project: 'fake', asset: 'fake', token: token},
    headers: {'Accept': 'application/json'}
  };
